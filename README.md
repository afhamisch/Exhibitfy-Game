...
a heavy Exhibitfy Bates numberer, plus a baked **`Stamp_Swing`** slam.
...
| File | What it is |
|---|---|
| `build/exhibitfy_fpv_arms.glb` | Runtime asset. glTF 2.0, PBR metallic-roughness, textures embedded, `Stamp_Swing` animation baked in. 1.14 MB. |
...
```
build_fpv_arms.py     the asset build: hands, arms, watch, stamp, pose, swing
tools/
